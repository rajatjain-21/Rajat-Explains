...
> Redux in version 16.3.0 introduced the [**Context API**](https://reactjs.org/docs/context.html), which makes Redux redundant for this use case of accessing the state from different parts of your app, so consider using the Context API instead of Redux, unless you need a specific feature that Redux provides.
